...
impl<Id: Intern, S: Default> Default for Interner<Id, S> {
    fn default() -> Self {
        Self::with_hasher(Default::default())
    }
}

impl<Id: Intern> Interner<Id> {
...
impl<Id: Intern, S> Interner<Id, S> {
...
impl<Id: Intern, S> Index<Id> for Interner<Id, S> {
    type Output = str;
...
impl<Id: Intern + Copy, S: BuildHasher> Interner<Id, S> {
