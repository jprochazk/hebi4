// Generated by asmgen at 2025-09-16T18:17:59.509302463+00:00[UTC]
//
...
pub enum Instruction {
    ...
    Isfalse { v: Reg, _b: u8, _c: u8 } = 15,
    Istruec { dst: Reg, v: Reg, _c: u8 } = 16,
    ...
    Isltv { dst: Reg, lhs: Reg, rhs: Reg } = 30,
    Islev { dst: Reg, lhs: Reg, rhs: Reg } = 31,
    Isgtv { dst: Reg, lhs: Reg, rhs: Reg } = 32,
    Isgev { dst: Reg, lhs: Reg, rhs: Reg } = 33,
    Iseqv { dst: Reg, lhs: Reg, rhs: Reg } = 34,
    Isnev { dst: Reg, lhs: Reg, rhs: Reg } = 35,
    Addvv { dst: Reg, lhs: Reg, rhs: Reg } = 36,
    Addvn { dst: Reg, lhs: Reg, rhs: Lit8 } = 37,
    Addnv { dst: Reg, lhs: Lit8, rhs: Reg } = 38,
    Subvv { dst: Reg, lhs: Reg, rhs: Reg } = 39,
    Subvn { dst: Reg, lhs: Reg, rhs: Lit8 } = 40,
    Subnv { dst: Reg, lhs: Lit8, rhs: Reg } = 41,
    Mulvv { dst: Reg, lhs: Reg, rhs: Reg } = 42,
    Mulvn { dst: Reg, lhs: Reg, rhs: Lit8 } = 43,
    Mulnv { dst: Reg, lhs: Lit8, rhs: Reg } = 44,
    Divvv { dst: Reg, lhs: Reg, rhs: Reg } = 45,
    Divvn { dst: Reg, lhs: Reg, rhs: Lit8 } = 46,
    Divnv { dst: Reg, lhs: Lit8, rhs: Reg } = 47,
    Unm { dst: Reg, rhs: Reg, _c: u8 } = 48,
    Not { dst: Reg, rhs: Reg, _c: u8 } = 49,
    Call { dst: Reg, args: Imm8, _c: u8 } = 50,
    Fastcall { dst: Reg, id: FnId } = 51,
    Ret { _a: u8, _b: u8, _c: u8 } = 52,
    Stop { _a: u8, _b: u8, _c: u8 } = 53,
}
