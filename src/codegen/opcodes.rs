// Generated by asmgen at 2025-09-27T15:42:17.739776119+00:00[UTC]
//
...
pub enum Instruction {
    ...
    Lcli { dst: Reg, id: Lit } = 21,
    Lfni { dst: Reg, id: Lit } = 22,
    Larr { dst: Reg, cap: Imm16 } = 23,
    Lobj { dst: Reg, cap: Imm16 } = 24,
    Jmp { rel: Imm24s } = 25,
...
#[doc = "Allocate an array with `capacity` into register `dst`."]
#[derive(Clone, Copy)]
#[repr(C, align(4))]
pub struct Larr {
    _op: u8,
...
pub mod asm {
    ...
    #[doc = "Allocate an array with `capacity` into register `dst`."]
    pub const fn larr(dst: Reg, cap: Imm16) -> Instruction {
        Instruction::Larr { dst, cap }
    }
    #[doc = "Allocate an object with `capacity` into register `dst`."]
    pub const fn lobj(dst: Reg, cap: Imm16) -> Instruction {
        Instruction::Lobj { dst, cap }
    }
    #[doc = "Adjust instruction pointer by `rel`."]
