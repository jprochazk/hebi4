// Generated by astgen at 2025-06-28T15:47:43.069065421+00:00[UTC]
//
...
#[derive(Clone, Copy)]
#[repr(transparent)]
pub struct Func(Packed);

impl Sealed for Func {}

impl From<Func> for Packed {
    #[inline]
    fn from(v: Func) -> Self {
        PackedNode::into_packed(v)
    }
...
/// SAFETY: `self` is a transparent wrapper over `Packed`.
unsafe impl PackedAbi for Func {
    #[inline]
    unsafe fn check_kind(kind: NodeKind) -> bool {
        kind == NodeKind::Func
    }
...
impl TryFrom<Expr> for Func {
    type Error = NodeCastError;
    #[inline]
    fn try_from(v: Expr) -> Result<Self, Self::Error> {
        if v.kind() != ExprKind::Func {
            return Err(NodeCastError);
        }
...
pub mod parts {
    ...
    pub struct IfSimple {
        pub cond: super::Expr,
        pub then: super::Expr,
        pub else_: Opt<super::Expr>,
    }
    pub struct IfMulti<'a> {
        pub tail: super::Block,
...
pub mod spanned {
    ...
    pub struct IfSimple {
        ...
        pub then: Spanned<super::Expr>,
        pub else_: Spanned<Opt<super::Expr>>,
    }
    pub struct IfMulti<'a> {
        pub tail: Spanned<super::Block>,
...
impl Pack for spanned::IfSimple {
    type Node = IfSimple;
    ...
    fn pack(self, ast: &mut AstBuilder) -> Self::Node {
        ...
        let then = <_>::into_spanned_packed(then);
        let else_ = <_>::into_spanned_packed(else_);
        let index = ast.append(&[cond, then, else_]);
        unsafe { Self::Node::from_packed(Packed::fixed_arity(NodeKind::IfSimple, index)) }
    }
}
...
impl<'a> Pack for spanned::Func<'a> {
    type Node = Func;
    ...
    fn pack(self, ast: &mut AstBuilder) -> Self::Node {
        ...
        unsafe { Self::Node::from_packed(Packed::mixed_arity(NodeKind::Func, length, index)) }
    }
}
...
impl Pack for spanned::Branch {
    ...
    fn pack(self, ast: &mut AstBuilder) -> Self::Node {
        ...
        unsafe { Self::Node::from_packed(Packed::fixed_arity(NodeKind::Branch, index)) }
    }
}
...
impl Unpack for IfSimple {
    ...
    unsafe fn unpack<'a>(self, ast: &'a Ast) -> Self::Node<'a> {
        ...
        let then = unsafe { <_>::from_packed(*raw.get_unchecked(1)) };
        let else_ = unsafe { <_>::from_packed(*raw.get_unchecked(2)) };
        Self::Node { cond, then, else_ }
    }
}
...
impl Unpack for Func {
    type Node<'a> = parts::Func<'a>;
...
impl Unpack for SetField {
    ...
    unsafe fn unpack<'a>(self, ast: &'a Ast) -> Self::Node<'a> {
        ...
        let parent = unsafe { <_>::from_packed(*raw.get_unchecked(0)) };
        let key = unsafe { <_>::from_packed(*raw.get_unchecked(1)) };
        let value = unsafe { <_>::from_packed(*raw.get_unchecked(2)) };
        let op = <AssignOp>::from_u24(repr.value);
        Self::Node {
            parent,
            key,
...
impl IfSimple {
    ...
    #[inline]
    pub fn then_span(&self, ast: &Ast) -> Span {
        let repr = unsafe { self.0.as_fixed_arity() };
        let index = repr.index as usize;
        ast.spans[index + 1]
    }
    ...
    #[inline]
    pub fn else_span(&self, ast: &Ast) -> Span {
        let repr = unsafe { self.0.as_fixed_arity() };
        let index = repr.index as usize;
        ast.spans[index + 2]
    }
...
pub fn walk_expr<V: ?Sized + Visitor>(
    ...
    match node.kind() {
        ...
        ExprKind::Func => {
            let node = unsafe { <_>::from_packed(node.0) };
            visitor.visit_func(ast, node, unsafe { node.unpack(ast) })
        }
...
pub trait Visitor {
    ...
    fn visit_var(
        ...
        self.visit_expr(ast, parts.value)?;
    ...
    fn visit_stmt_expr(
        ...
        self.visit_expr(ast, parts.inner)?;
    ...
    fn visit_if_simple(
        ...
        ast: &Ast,
        node: IfSimple,
        parts: parts::IfSimple,
    ) -> std::result::Result<(), Self::Error> {
        self.visit_expr(ast, parts.cond)?;
        self.visit_expr(ast, parts.then)?;
        if let Some(node) = parts.else_.into() {
            self.visit_expr(ast, node)?;
        }
    ...
    fn visit_if_multi(
        ...
        self.visit_block(ast, parts.tail)?;
    ...
    fn visit_func(
        ...
        self.visit_block(ast, parts.body)?;
    ...
    fn visit_get_field(
        ...
        self.visit_expr(ast, parts.parent)?;
    ...
    fn visit_call(
        ...
        self.visit_expr(ast, parts.callee)?;
    ...
    fn visit_infix(
        ...
        self.visit_expr(ast, parts.lhs)?;
        self.visit_expr(ast, parts.rhs)?;
    ...
    fn visit_object(
        ...
        for node in parts.entries {
            self.visit_object_entry(ast, *node)?;
        }
